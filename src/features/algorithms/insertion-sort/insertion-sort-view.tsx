...
import { implementations, insertionSortDescription } from './data';
import { InsertionSortComparison } from './components/insertion-sort-comparison';
    ...
    <div className="space-y-12">
      ...
      <Card>
        ...
        <CardContent>
          <div className="prose dark:prose-invert max-w-none">
            <p className="whitespace-pre-wrap">{insertionSortDescription}</p>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="space-y-4">
        ...
        <InteractiveDemo
          ...
          description="Verdiğiniz dizi Insertion Sort ile sıralanacaktır."
          algorithmFunction={insertionSort}
          inputType="array"
          inputPlaceholder="12,11,13,5,6"
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          >
            <h3 className="font-bold text-ink mb-1">Shell Sort</h3>
            <p className="text-sm text-ash">
              Aralıklı eklemeli sıralama algoritması.
            </p>
          </Link>
          <Link
          ...
          >
            ...
            <p className="text-sm text-ash">
              Insertion ve Merge sort tabanlı hibrit.
            </p>
          </Link>
        </div>
      </div>
