...
import type {
  CodeLanguage,
  AlgorithmRelatedItem,
} from './algorithm-page-template';
...
export function AlgorithmCodeSection({
  title,
  codeIntro,
  codeExamples,
  defaultCodeTab,
...
export function AlgorithmAnalysisSection({
  timeComplexity,
  spaceComplexity,
  analysisRightTitle,
    ...
    <section className="space-y-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div>
              <h3 className="mb-3 font-semibold text-emerald-500 dark:text-emerald-400">
                Avantajlar
              </h3>
...
export function AlgorithmRelatedSection({
  title,
  relatedIntro,
  relatedAlgorithms,
  ...
  resolveAlgorithmHref: (title: string, href?: string) => string | undefined;
}) {
  return (
    <section className="space-y-4">
