...
export const NavigationItem = ({
        ...
        <DropdownMenuTrigger asChild>
          <button
            ...
            className={cn(
              ...
              'flex items-center gap-1.5 py-1.5 px-2.5 rounded-none border border-transparent',
  ...
  return (
    <Link
      href={item.href}
      className={cn(
        'font-mono text-[0.76rem] font-semibold uppercase tracking-wider transition-colors py-1.5 px-2.5',
        'hover:text-ink',
        isActiveNavItem(item) ? 'text-green' : 'text-muted',
      )}
    >
